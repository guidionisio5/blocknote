...
<body>
    ...
    <form id="salvarAnotacoes" class="container-escritor" method="post">
        ...
        <div class="escrita">
            <h5>Central do Escritor</h5>
                <textarea id="anotacoes-editar" name="anotacoes" class="bloco-escrever img-fundo" onkeydown="tirarImg()" onchange="voltaImg()"></textarea>
            <h5>Descrição</h5>
                <textarea class="bloco-descricao img-descricao" name="descricao" id="descricao-editar" onkeydown="tirarTxt()" onchange="voltaTxt()"></textarea>
            <div class="mt-3 mb-3">
    ...
    <!-- Modal -->
    <div class="modal fade" id="salvarModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" id="modal-cor">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="editarAnotacoes()">Salvar</button>
                </div>
            </div>
        </div>
    </div>
   <!-- fim do modal -->
    ...
    <script src="assets/js/script-editarEscritor.js"></script>
